...
mango2 = new Mango(930,300,20)
mango3 = new Mango(960,300,20)
mango4 = new Mango(990,300,20)
mango5 = new Mango(1020,300,20)
mango6 = new Mango(1050,300,20)
sling = new Sling(stone.body, {x: 120, y: 450}) 
tree = createSprite(800,170,70,500)
